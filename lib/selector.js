...
function retryWithOptions (options) {
...
Selector.prototype.wait = function (options) {
  var retry = retryWithOptions(options)
  return this._conditions.wait(this.scope, {retry: retry})
}
