...
module.exports = {
  ...
  text: function ($el, message, text) {
    assertElementProperties(this.get('$'), $el, text, function (e) { return normaliseText(e) }, text === '')
  },
  ...
  exactText: function ($el, message, exactText) {
    assertElementProperties(this.get('$'), $el, exactText, function (e) { return normaliseText(e) }, true)
  },
