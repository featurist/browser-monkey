...
module.exports = {
  ...
  select: function (value) {
    return this.is('select').anyOf([
      function (monkey) {
        return monkey.find('option', {exactText: value})
      },
      function (monkey) {
        return monkey.find('option', {exactValue: value})
      }
  ...
  selectValue: function () {
    return this.is('select').find('option').elements().mapAll(function (options) {
