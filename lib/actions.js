...
module.exports = {
  ...
  click: function (options) {
    var self = this
    var defaultOptions = {button: 'left'}
    ...
    var mouseEventData = {
      ...
      middle: {
        mousedown: {which: 2, button: 1},
        mouseup: {which: 2, button: 1}
      }
    }[options.button]
    ...
    return self.enabled().element(options).then(function (element) {
      ...
      element.trigger('mousedown', mouseEventData.mousedown)
      element.trigger('mouseup', mouseEventData.mouseup)
      element.trigger('click', mouseEventData.click)
